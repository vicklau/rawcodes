...
var middleTextTop = textCenter.append("text")
    ...
    .attr("dy", "1em")
    .attr("opacity", 1)
    .text("While the city frantically seeks longer-term solutions to housing shortage, the 2016 By-Census reveals some interesting facts on 'INTERNAL MIGRATION'")
    .call(wrap, 350);

/*  Text from middle bottom */
var middleTextBottom = textCenter.append("text")
    ...
    .attr("dy", "1em")
    .attr('opacity', 1)
    .text("In the following chart, we visualise the census figures showing how the extent and direction of movement of Hong Kong people between 2011 and 2016.")
    .call(wrap, 350);
...
function Draw4() {
    ...
    svg.selectAll("g.group")
        .transition().duration(700)
        .selectAll(".tickLabels").style("opacity", function (d, i, j) {
            if (j == 5 || j == 4) {
                return 1;
            } else {
                return opacityValue;
    ...
    svg.selectAll("g.group")
        .transition().duration(700)
        .selectAll(".titles").style("opacity", function (d) {
            if (d.index == 4 || d.index == 5) {
                return 1;
            } else {
                return opacityValue;
...
function Draw9() {
    ...
    d3.selectAll(".NokiaToSamsungArc")
        ...
        .attr("opacity", 0)
        .each("end", function () {
            d3.selectAll(".NokiaToSamsungArc").remove();
        });
    ...
    d3.selectAll(".SamsungToNokiaArc")
        ...
        .attr("opacity", 0)
        .each("end", function () {
            d3.selectAll(".SamsungToNokiaArc").remove();
        });
    ...
    chords.transition().duration(2000)
        .attr("opacity", function (d, i) {
            if (d.source.index == 0 && d.target.index == 0) {
                return opacityValueBase;
            } else if (d.source.index == 1 && d.target.index == 1) {
                return opacityValueBase;
            } else if (d.source.index == 2 && d.target.index == 2) {
                return opacityValueBase;
            } else if (d.source.index == 3 && d.target.index == 3) {
                return opacityValueBase;
            } else if (d.source.index == 4 && d.target.index == 4) {
                return opacityValueBase;
            } else if (d.source.index == 5 && d.target.index == 5) {
                return opacityValueBase;
            } else if (d.source.index == 6 && d.target.index == 6) {
                return opacityValueBase;
            } else if (d.source.index == 7 && d.target.index == 7) {
                return opacityValueBase;
            } else {
                return 0;
            }
...
function Draw10() {
    ...
    chords.transition().duration(2000)
        .attr("opacity", function (d, i) {
            if (d.source.index == 4 && d.target.index == 4) {
                return opacityValueBase;
            } else {
                return 0;
            }
...
function Draw11() {
    ...
    d3.selectAll(".NokiaLoyalArc")
        ...
        .attr("opacity", 0)
        .each("end", function () {
            d3.selectAll(".NokiaLoyalArc").remove();
        });
...
function Draw13() {
    ...
    function repeat() {
        chords
            ...
            .style("opacity", function (d) {
                if (d.source.index == 0) {
                    if (d.target.index == 0 || d.target.index == 5) {
                        return opacityValueBase;
                    } else {
                        return 0.2;
                    }
